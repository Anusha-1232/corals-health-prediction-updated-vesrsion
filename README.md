...
How It Works
Environmental datasets are preprocessed and merged.
A classification model (e.g., Random Forest) is trained on labeled data.
The web app takes inputs like year, temperature, and species richness.
The trained model predicts coral health and displays results.
